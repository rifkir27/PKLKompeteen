...
class InfrastructureController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        */
        $infrastructures = Infrastructure::orderBy('created_at', 'DESC')->get();
        // dd($mentors);

        // passing variabel $infrastructures kedalam view.
        return view('landing.infrastructure.index', compact('infrastructures'));
    }
}
