...
@section('content')
    <div class="row">
        <div class="col-12">
            <x-button-create title="ADD NEW COURSE" :url="route('member.course.create')" />
                    ...
                    <tbody>
                        @foreach ($courses as $i => $course)
                            <tr>
                                ...
                                <td>{{ $course->series }}</td>
                                <td>
                                    <a href="{{ Route('member.series.index', $course->slug) }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-list"></i>
                                    </a>
                                    <a href="{{ route('member.course.edit', $course->id) }}" class="btn btn-warning btn-sm">
