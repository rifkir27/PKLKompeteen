@extends('layouts.backend.app', ['title' => 'Edit Articles'])
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <form class="form-horizontal" method="POST"
                                action="{{ route('admin.articles.update', $article->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror">{{ $article->content }}</textarea>
                                            @error('content')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" class="form-control" id="published_at"
                                                name="published_at"
                                                value="{{ \Carbon\Carbon::parse($article->published_at)->format('Y-m-d\TH:i') }}">
                                        </div>
                                    </div>
                                </div>
