@extends('layouts.backend.app', ['title' => 'Add Photo'])
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="POST" action="{{ route('admin.courses.photos.store', $course->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
