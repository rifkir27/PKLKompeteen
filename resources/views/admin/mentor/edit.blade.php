@extends('layouts.backend.app', ['title' => 'Edit Mentor'])
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('admin.mentor.index') }}" class="btn btn-success">
                            ...
                            <form class="form-horizontal" method="POST"
                                action="{{ route('admin.mentor.update', $mentor->id) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description"
                                            class="form-control @error('description') is-invalid @enderror">{{ old('description', $mentor->description) }}</textarea>
                                        @error('description')
                                            <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                            $pathParts = explode('/', $mentor->image);
                                            $fileName = end($pathParts); // ambil nama file terakhir
                                        @endphp
                                        <br>
                                        <img src="{{ asset('storage/mentor/' . $fileName) }}"
                                            alt="Mentor Image" height="100px" width="100px">
                                    </div>
...
@push('scripts')
    ...
    <script src="https://cdn.tiny.cloud/1/czpou863v7lzjbday6jmfcorhq0gyyaigh2bogm7e2zwe6sj/tinymce/6/tinymce.min.js"
