        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @endrole
                    @role('member')
                        <li class="nav-header text-uppercase text-gray-400 text-sm mt-3 mb-1">
                            Member Menu
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('member.dashboard') }}" class="nav-link {{ active('member.dashboard') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon text-blue-400" width="22" height="22"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path d="M4 12l8 -8l8 8v8a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-6h-4v6a2 2 0 0 1 -2 2h-4"></path>
                                </svg>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('member.mycourse') }}" class="nav-link {{ active('member.mycourse*') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon text-green-400" width="22" height="22"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('member.showcases.index') }}" class="nav-link {{ active('member.showcases*') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon text-purple-400" width="22" height="22"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M14.5 4h2.5a3 3 0 0 1 3 3v10a3 3 0 0 1 -3 3h-10a3 3 0 0 1 -3 -3v-5"></path>
                                    <path d="M6 5l-2 2l2 2"></path>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('member.transactions.index') }}" class="nav-link {{ active('member.transactions*') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon text-yellow-400" width="22" height="22"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16l-3 -2l-2 2l-2 -2l-2 2l-2 -2l-3 2"></path>
                                    <path d="M9 7h6m-6 4h6m-2 4h2"></path>
                                </svg>
                                <p>Transaction</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('member.voucher.redeem') }}" class="nav-link {{ active('member.voucher*') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon text-pink-400" width="22" height="22"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M20 3H5a2 2 0 0 0 -2 2v14a2 2 0 0 0 2 2h15a2 2 0 0 0 2 -2V5a2 2 0 0 0 -2 -2z"></path>
                                    <path d="M5 7h14M5 11h10M5 15h6"></path>
                                </svg>
                                <p>Voucher</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('member.profile.index') }}" class="nav-link {{ active('member.profile.index') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon text-gray-300" width="22" height="22"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <circle cx="12" cy="12" r="9"></circle>
                                    <circle cx="12" cy="10" r="3"></circle>
