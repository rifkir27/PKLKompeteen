        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                @role('admin')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.tools.index') }}" class="nav-link {{ active('admin.tools*') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tool" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <path d="M7 10h3v-3l-3.5 -3.5a6 6 0 0 1 8 8l3.5 3.5v3h-3v4a2 2 0 0 1 -4 0v-4h-3a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2z" />
                            </svg>
                            <p>
                                Tools
                            </p>
                ...
                @role('member')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('member.favorites') }}" class="nav-link {{ active('member.favorites') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-heart nav-icon"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25"
                                stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
