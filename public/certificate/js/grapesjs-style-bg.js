/*! grapesjs-style-bg - 2.0.1 */ ! function (e, t) {
        ...
        const y = function (n, r) {
            ...
            n.Styles.addBuiltIn('background', {
                ...
                toStyle: function (n) {
                    ...
                    return delete r[d], delete r[p], delete r[f], delete r[h], delete r[v], i(i({}, r), {
                ...
                properties: [{
                    ...
                    onChange: function (t) {
                        ...
                        r && n.getParent().getProperties().forEach((function (t) {
                            var n = t.getName(),
                                o = !1;
                            n !== s && ((r === e.Image && [p, f, h, v].indexOf(n) < 0 || r === e.Color && n === p || r === e.Grad && [f, h, v].indexOf(n) >= 0) && (o = !0), t.up({
                                visible: o
                            }))
                        }))
                    },
