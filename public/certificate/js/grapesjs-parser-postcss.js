/*! grapesjs-parser-postcss - 1.0.1 */ ! function (e, t) {
    ...
    var e = {
            ...
            995: (e, t, s) => {
                ...
                let {
                    ...
                    nanoid: h
                } = s(961), u = s(868), c = s(671), p = s(981), f = Symbol('fromOffsetCache'), d = Boolean(r && i), m = Boolean(l && a);
                class g {
                    constructor(e, t = {}) {
            ...
            939: (e, t, s) => {
                ...
                let {
                    isClean: r,
                    my: i
                } = s(513), n = s(505), o = s(88), l = s(19), a = s(461), h = (s(448), s(632)), u = s(964), c = s(25);
                const p = {
                        document: 'Document',
                        root: 'Root',
                        atrule: 'AtRule',
                ...
                class v {
                    constructor(e, t, s) {
                        ...
                        if (this.stringified = !1, this.processed = !1, 'object' != typeof t || null === t || 'root' !== t.type && 'document' !== t.type)
                            if (t instanceof v || t instanceof h) r = x(t.root), t.map && (void 0 === s.map && (s.map = {}), s.map.inline || (s.map.inline = !1), s.map.prev = t.map);
                            else {
                                let e = u;
                                ...
                                for (let s in t) {
                                    ...
                                    if (!d[s])
                                        if ('object' == typeof t[s])
                                            for (let r in t[s]) e(t, '*' === r ? s : s + '-' + r.toLowerCase(), t[s][r]);
                    ...
                    visitTick(e) {
                        ...
                        if (0 !== t.iterator) {
                            ...
                            for (; i = s.nodes[s.indexes[n]];)
                                if (s.indexes[n] += 1, !i[r]) return i[r] = !0, void e.push(y(i));
            ...
            505: (e, t, s) => {
                ...
                let {
                    ...
                    pathToFileURL: h
                } = s(414), u = s(995), c = Boolean(r && i), p = Boolean(n && o && l && a);
                e.exports = class {
                    constructor(e, t, s, r) {
                    ...
                    applyPrevMaps() {
                        for (let e of this.previous()) {
                            let t, s = this.toUrl(this.path(e.file)),
                                i = e.root || n(e.file);
                ...
                class h {
                    ...
                    positionBy(e) {
                        ...
                        if (e.index) t = this.positionInside(e.index);
                            ...
                            let s = this.toString().indexOf(e.word); - 1 !== s && (t = this.positionInside(s))
                        }
                        return t
                    }
                    rangeBy(e) {
                        ...
                        if (e.word) {
                            let r = this.toString().indexOf(e.word); - 1 !== r && (t = this.positionInside(r), s = this.positionInside(r + e.word.length))
                        } else e.start ? t = {
                            line: e.start.line,
                ...
                e.exports = class {
                    ...
                    decl(e, t) {
                        ...
                        for (';' === n[0] && (this.semicolon = !0, e.pop()), s.source.end = this.getPosition(n[3] || n[2] || function (e) {
                            ...
                            'word' !== e[0][0];) 1 === e.length && this.unknownWord(e), s.raws.before += e.shift()[1];
            ...
            723: (e, t, s) => {
                ...
                class l {
                    ...
                    normalize(e) {
                        let t = [];
                        for (let s of e)
                            if (!0 === s.postcss ? s = s() : s.postcss && (s = s.postcss), 'object' == typeof s && Array.isArray(s.plugins)) t = t.concat(s.plugins);
            ...
            852: e => {
                ...
                e.exports = function (e, k = {}) {
                    let S, A, P, R, E, M, I, j, U, B, F = e.css.valueOf(),
                        L = k.ignoreErrors,
                        D = F.length,
                        z = 0,
                        _ = [],
